...
sub printCMD {
	...
	print STDERR "\t\tgene: outputs the gene nucleotide sequence based on RefSeq of Gene ID annotation\n";
	print STDERR "\t\tprotein: outputs the amino acid sequence of a gene based on RefSeq or Gene ID annotation\n";
	print STDERR "\t\tboth: outputs the nucleotide and amino acid sequence of a gene based on RefSeq or GENE ID annotation\n";
	...
	print STDERR "\t\tgenomic: outputs the nucleotide sequence for any specified locus\n";
	...
	print STDERR "\t\tgenomic_both: outputs the nucleotide and amino acid sequence of specified locus\n";
	print STDERR "\t\talign_gene: outputs the alignment of nucleotide gene sequence based on mutation annotations in VCF file\n";
	print STDERR "\t\talign_protein: outputs the alignment of protein sequence. For this the nucleotide sequences are aligned based on mutations from the VCF file and then translated into amino acid sequences\n";
	print STDERR "\t\talign_both: outputs the alignment of the nucleotide and amino acid sequence for a gene based on the mutations in VCF file\n";
	print STDERR "\t\talig_genomic_gene: outputs the alignment the nucleotide sequence of a locus specified with -chr, -start, -end (and -strand)\n";
	print STDERR "\t\talign_genomic_protein: outputs the alignment of the amino acid sequence of a locus specified with -chr, -start, -end (and -strand). For this the nucleotide sequences are aligned based on mutations from the VCF file and then translated into amino acid sequences\n";
	print STDERR "\t\talign_genomic_both: outputs the alignment of the nucleotide and amino acid sequence for a locus specified with -chr, -start, -end (and -strand)\n\n";
